...
export default function useTimer(expiry: Date, onExpire: () => void, autoStart: boolean = true) {
  ...
  function restart(newExpiryTimestamp: Date, newAutoStart: boolean = true) {
